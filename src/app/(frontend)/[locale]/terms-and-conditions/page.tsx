...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    ...
    alternates: {
      canonical: locale === 'pt' ? 'https://www.algarveboatsales.com/pt/terms-and-conditions' : 'https://www.algarveboatsales.com/terms-and-conditions',
      languages: hreflangAlternates('/terms-and-conditions'),
    },
  }
}
