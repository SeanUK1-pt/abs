...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    ...
    alternates: {
      canonical: locale === 'pt' ? 'https://www.algarveboatsales.com/pt/sell-your-boat' : 'https://www.algarveboatsales.com/sell-your-boat',
      languages: hreflangAlternates('/sell-your-boat'),
    },
  }
}

export default async function SellYourBoatPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale: localeParam } = await params
  const locale = getLocaleFromParam(localeParam)
  const page = await getPageData('sell-your-boat', locale)
